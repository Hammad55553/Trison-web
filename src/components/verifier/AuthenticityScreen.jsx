              ...
              <Card className="auth-form-card" glow={true} interactive={false}>
                ...
                {scanMode === 'camera' ? (
                  <div className="camera-scanner-wrapper">
                    ...
                    {scanHelpMessage && (
                      <div className="scan-help-message" style={{ padding: '12px 16px', backgroundColor: '#f8fafc', color: '#1e293b', fontSize: '14px', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', borderTop: '1px solid var(--card-border)' }}>
